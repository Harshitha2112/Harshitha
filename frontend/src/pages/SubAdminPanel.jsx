...
import { getPendingRecipes, updateStatus, deleteRecipe, getComments, deleteComment } from "../services/api";
import toast from "react-hot-toast";
import { CheckCircle, XCircle, Trash2, MessageSquare, ChefHat } from "lucide-react";
      ...
      <div style={{ display: "flex", gap: "0.5rem", marginBottom: "1.5rem" }}>
        {["recipes"].map(tab => (
          <button key={tab} onClick={() => setActiveTab(tab)}
            style={{ padding: "0.5rem 1.25rem", borderRadius: "999px", fontSize: "0.82rem", fontWeight: 600, border: "1px solid var(--border)", cursor: "pointer", textTransform: "capitalize",
